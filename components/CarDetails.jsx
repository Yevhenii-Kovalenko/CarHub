      ...
      <Dialog as="div" className='relative z-10' onClose={closeModal}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          ...
          leaveTo="opacity-0 scale-95">
              <Dialog.Panel className='relative w-full max-w-lg max-h-[90vh] overflow-y-0 transform rounded-2xl bg-white p-6 text-left shadow-xl transition-all felx flex-col gap-5'>
